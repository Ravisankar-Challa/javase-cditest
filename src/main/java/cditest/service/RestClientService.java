...
import static cditest.util.Constants.X_CORRELATION_ID;
...
import cditest.exception.RequestTimeOutException;
import cditest.exception.UnsuccesfulResponseException;
import cditest.model.ResponseStats;
import cditest.model.Time;
...
public class RestClientService {
    ...
    protected <T> T execute(final String httpMethod, final String url, final Map<String, Object> urlParameters,
        ...
        try {
            ...
            Response response = (body != null) ? requestBuilder.method(httpMethod, Entity.json(body))
                                               : requestBuilder.method(httpMethod);
            if (Family.SUCCESSFUL == Family.familyOf(response.getStatus())) {
