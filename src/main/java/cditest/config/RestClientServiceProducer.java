...
import cditest.filter.GZIPDecoder;
import cditest.filter.JaxrsClientLoggingFilter;
import cditest.filter.JsonContentTypeResponseFilter;
import cditest.service.RestClientService;
